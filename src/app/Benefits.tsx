  ...
  return (
    <section className="py-12 sm:py-16 bg-white">
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-10">
        ...
        >
          {/* Heading */}
          <h2 className="text-2xl sm:text-3xl font-semibold text-gray-800 mb-10 sm:mb-16 md:mb-20 ml-4 sm:ml-10 md:ml-0 mt-8 sm:mt-12 md:mt-0">
            <span className="text-black border-l-4 sm:border-l-8 border-blue-500 pl-2">
              WHY CHOOSE IT
            </span>
          </h2>

          {/* Paragraph */}
          <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8 sm:mb-12 md:mb-20 text-justify mx-4 sm:mx-6 md:mx-0">
            Not all that Mrs. Bennet, however, with the assistance of her five daughters, could ask on the subject, 
            was sufficient to draw from her husband any satisfactory description of Mr. Bingley...
          </p>
          ...
          <ul className="space-y-6 sm:space-y-8">
            ...
            >
              ...
              <div>
                <h4 className="font-semibold text-lg sm:text-xl md:text-2xl">24H SUPPORT</h4>
                <p className="text-gray-600 text-sm sm:text-base py-2 sm:py-3">
                  Not all that Mrs. Bennet, however, with the assistance of her five daughters, could ask on the subject.
                </p>
              </div>
            </li>
            ...
            >
              ...
              <div>
                <h4 className="font-semibold text-lg sm:text-xl md:text-2xl">REGULAR UPDATES</h4>
                <p className="text-gray-600 text-sm sm:text-base py-2 sm:py-3">
                  Not all that Mrs. Bennet, however, with the assistance of her five daughters, could ask on the subject.
                </p>
              </div>
            ...
            >
              ...
              <div>
                <h4 className="font-semibold text-lg sm:text-xl md:text-2xl">MANY BROWSER</h4>
                <p className="text-gray-600 text-sm sm:text-base py-2 sm:py-3">
                  Not all that Mrs. Bennet, however, with the assistance of her five daughters, could ask on the subject.
                </p>
              </div>
